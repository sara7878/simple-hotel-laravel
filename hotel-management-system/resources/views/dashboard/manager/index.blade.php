          ...
          <div class="col-12">
            <div class="card">
              <div class="card-header">
                <h3 class="card-title">Display all Manger </h3>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
                <table id="example2" class="table table-bordered table-hover">
                  ...
                  <tr>
                    ...
                    {{-- <td>{{ $manager->avatar_img }}</td> --}}
                    <td><img src='{{ asset("uploads/manager/$manager->avatar_img") }}'' width="50" height="50" alt=""></td>

                    <td><a href="{{ route('manager.edit',$manager->id)}}" class="btn btn-success">Edit</a></td>
                    <td>
