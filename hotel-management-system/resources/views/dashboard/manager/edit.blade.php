                        ...
                        <form method="POST" action="{{ route('manager.update',$manager->id) }}" enctype="multipart/form-data">
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="name" name="name" class="form-control" id="exampleInputName" value="{{ old('name') ?? $manager ->name}}"
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="email" name="email" class="form-control" id="exampleInputEmail1" value="{{ old('email') ?? $manager ->email}}"
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="password" name="password" class="form-control" id="exampleInputPassword1" value="{{ old('password') ?? $manager ->password }}"
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="file" class="form-control" name="avatar_img" value="{{ old('avatar_img') ?? $manager ->avatar_img }}"
                                ...
                                {{-- <div class="form-group">
                                    <img src="{{ $manager->avatar_img }}" style="width: 100px" class="img-thumbnail image-preview" alt="">
                                </div> --}}

                                </div>
                                <div class="form-check">
                                    <label for="exampleInputFile">National Id</label>
                                    <input type="number" name="national_id" class="form-control" id="exampleInputName"
                                        class="@error('national_id') is-invalid @enderror" placeholder="Enter National Id" value="{{ old('national_id') ?? $manager ->national_id }}"  >
                                        @error('national_id')
                                        <div class="alert alert-danger">{{ $message }}</div>
                                @enderror
                                </div>
