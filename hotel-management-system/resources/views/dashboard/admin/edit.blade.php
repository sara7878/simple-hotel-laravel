                        ...
                        <form method="POST" action="{{ route('admin.update',$admin->id) }}" enctype="multipart/form-data">
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="name" name="name" class="form-control" id="exampleInputName" value="{{ old('name') ?? $admin ->name}}"
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="email" name="email" class="form-control" id="exampleInputEmail1" value="{{ old('email') ?? $admin ->email}}"
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="password" name="password" class="form-control" id="exampleInputPassword1" value="{{ old('password') ?? $admin ->password }}"
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="file" class="form-control" name="avatar_img" value="{{ old('avatar_img') ?? $admin ->avatar_img }}"
                                ...
                                {{-- <div class="form-group">
                                    <img src="{{ $admin->avatar_img }}" style="width: 100px" class="img-thumbnail image-preview" alt="">
                                </div> --}}
                                ...
                                <div class="form-check">
                                    ...
                                    <input type="number" name="national_id" class="form-control" id="exampleInputName"
                                        class="@error('national_id') is-invalid @enderror" placeholder="Enter National Id" value="{{ old('national_id') ?? $admin ->national_id }}"  >
                                        @error('national_id')
                                        <div class="alert alert-danger">{{ $message }}</div>
                                @enderror
                                </div>
